document.addEventListener('DOMContentLoaded', () => {
  ...
  const services = {
    ...
    accounting: {
      title: 'برنامج Bayah المحاسبي',
      brief: 'برنامجنا المحاسبي الخاص، جاهز للتركيب السريع بإعدادات مسبقة تناسب أغلب الشركات، ويغطي المبيعات والمشتريات وحسابات العملاء والموردين والمخازن في تقارير مالية لحظية.',
      link: 'media.html?service=accounting'
    },
    cashier: {
      title: 'Cashier',
